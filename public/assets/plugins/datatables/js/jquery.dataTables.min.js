...
(function (l) {
            ...
            !a.sEmptyTable && d && `
             <div class="noresult" style="display: block;">
                      <div class="text-center">
                          ...
                          <h5 class="mt-2">Opps! No data</h5>
                          <p class="text-muted">Your data is still empty.</p>
                      </div>
                  </div>
            ` === b.sEmptyTable && X(a, a, "sZeroRecords", "sEmptyTable");
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: ` <div class="noresult" style="display: block;">
                      <div class="text-center">
                          <lord-icon src="https://cdn.lordicon.com/bbnkwdur.json"
                          trigger = "loop"
                          colors = "primary:#405189,secondary:#0ab39c"
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: `<div class="noresult" style="display: block;">
                                  <div class="text-center">
                                      <lord-icon src="https://cdn.lordicon.com/msoeawqm.json" trigger="loop" colors="primary:#405189,secondary:#0ab39c" style="width:75px;height:75px">
                                      </lord-icon>
                                      <h5 class="mt-2">Opps! Data Tidak Ditemukan</h5>
                                      <p class="text-muted">Maaf, kami tidak menemukan apa yang kamu cari.</p>
                                  </div>
                              </div>`
        },
